...
def test_basic():
    ...
    cce = elegy.losses.CategoricalCrossentropy(from_logits=False, sparse_labels=False)
    ...
    cce = elegy.losses.CategoricalCrossentropy(
        from_logits=False, sparse_labels=False, reduction=elegy.losses.Reduction.SUM
    )
    ...
    cce = elegy.losses.CategoricalCrossentropy(
        from_logits=False, sparse_labels=False, reduction=elegy.losses.Reduction.NONE
    )
