...
class ElegyModule(eg.CoreModule):
    ...
    apply_fn: tp.Callable[..., tp.Tuple[tp.Any, Variables]]
    ...
    def init_step(
        ...
        variables = self.init_fn(init_key, inputs, training=False)
