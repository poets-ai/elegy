...
# ==============================================================================
"""Group normalization implementation based on haiku: https://raw.githubusercontent.com/deepmind/dm-haiku/master/haiku/_src/group_norm.py
and Tensorflow."""
...
class GroupNormalization(module.Module):
    ...
    $$ outputs = scale \dfrac{x - \mu}{\sigma + \epsilon} + offset$$
    ...
    def _initialize(self, x: jnp.ndarray, channels: int):
        ...
        if self.channel_index == -1:
            ...
            self.group_shape = (-1, self.groups, channels // self.groups) + x.shape[2:]
