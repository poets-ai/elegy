...
def L1Regularization(l=0.01) -> L1L2Regularization:
  ...
  """
    return L1L2Regularization(l1=l)


def L2Regularization(l=0.01) -> L1L2Regularization:
  ...
  """
    return L1L2Regularization(l2=l)
